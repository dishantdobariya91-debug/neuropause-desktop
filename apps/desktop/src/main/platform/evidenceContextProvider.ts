...
export const evidenceContextProvider: {
  current: ((opts: { query?: string; correlationId?: string; limit?: number; relevanceQuery?: string; includePosture?: boolean }) => AiContextItem[]) | null;
} = { current: null };
 ...
 */
export function resolveEvidenceContext(opts: { query?: string; correlationId?: string; limit?: number; relevanceQuery?: string; includePosture?: boolean } = {}): AiContextItem[] {
  try {
